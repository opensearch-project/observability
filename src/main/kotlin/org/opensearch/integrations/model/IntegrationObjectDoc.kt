...
data class IntegrationObjectDoc(
    ...
    companion object {
        ...
        fun parse(parser: XContentParser, useId: String? = null): IntegrationObjectDoc {
            ...
            while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    ACCESS_LIST_FIELD -> access = parser.stringList()
                        ...
                        if (objectTypeForTag != IntegrationObjectType.NONE && objectData == null) {
                            objectData =
                                IntegrationObjectDataProperties.createObjectData(objectTypeForTag, parser)
                            type = objectTypeForTag
                        } else {
                            parser.skipChildren()
                            log.info("Unexpected field: $fieldName, while parsing IntegrationObjectDoc")
                        }
                    }
                }
            }
