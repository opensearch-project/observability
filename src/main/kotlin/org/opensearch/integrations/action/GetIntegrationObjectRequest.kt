...
class GetIntegrationObjectRequest : ActionRequest, ToXContentObject {
    ...
    companion object {
        private val log by logger(GetIntegrationObjectRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { GetIntegrationObjectRequest(it) }
        ...
        fun parse(parser: XContentParser): GetIntegrationObjectRequest {
            ...
            return GetIntegrationObjectRequest(
                objectIdList,
                types,
                fromIndex,
                maxItems,
