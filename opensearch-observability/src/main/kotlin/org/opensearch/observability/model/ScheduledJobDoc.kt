...
internal data class ScheduledJobDoc(
    ...
    val enabled: Boolean
    // TODO: val jobInfo: BaseJobData? -> metric/uptime
) : ScheduledJobParameter, BaseModel {

    internal enum class JobType { Metrics, Uptime } // TODO: need change
...
//         */
//        val reader = Writeable.Reader { ScheduledJobDoc(it) }
        ...
        fun parse(parser: XContentParser, useId: String? = null): ScheduledJobDoc {
            var id: String? = useId
...
//        jobType = input.readEnum(ObservabilityObjectType::class.java),
//        scheduleInfo = input.readOptionalWriteable(
//           Schedule::class.java
//        )
//    )
    ...
    override fun getName(): String {
        return "poc name" // TODO: need add this field
    }
