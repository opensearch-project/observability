...
import {
  BASE_OBSERVABILITY_URI,
  SAVED_OBJECT
} from '../../common/constants/shared';

export function SavedObjectsPlugin(Client: any, config: any, components: any) {
...
//   });
  ...
  observability.saveSearch = clientAction({
    url: {
      fmt: `${BASE_OBSERVABILITY_URI}${SAVED_OBJECT}`,
    },
    method: 'POST',
    needBody: true,
  });
